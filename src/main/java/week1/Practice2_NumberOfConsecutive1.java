...
public class Practice2_NumberOfConsecutive1 {
    ...
    public void example1(){
        ...
        // output : 4
        Assert.assertEquals(numberOfConsecutiveOnes(nums),4);
    }
    ...
    public void example2(){
        int[] nums = new int[] {0};
        //output : 0
        Assert.assertEquals(numberOfConsecutiveOnes(nums),0);
    }
    ...
    public void example3(){
        ...
        //Output : 1
        Assert.assertEquals(numberOfConsecutiveOnes(nums),1);
    }
